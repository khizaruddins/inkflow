    ...
    <div className="min-h-screen bg-background font-sans">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <aside className="hidden lg:block lg:col-span-2 space-y-6 border-r border-border/40 pr-4">
                  ...
                  <div className="flex flex-wrap gap-1.5 px-0.5">
                    {topicsList.map((topic) => (
                      <Link
                        ...
                        className="px-2.5 py-1 rounded-full text-xs font-medium bg-muted/60 text-muted-foreground hover:bg-primary/10 hover:text-primary transition-colors border border-border/40"
                      >
                        {topic}
                      </Link>
                    ))}
