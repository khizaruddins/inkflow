...
const SHORTCUT_PAGES: Array<ShortcutItem[]> = [
  [
    ...
    { keys: ['*', 'Space'], title: 'Bulleted list', description: 'Or type - and Space' },
    { keys: ['1', '.', 'Space'], title: 'Ordered list', description: 'Or type 1. / 1) and press Space or Enter' },
    { keys: ['Enter'], title: 'Continue list item', description: 'Auto-numbers (2., 3...) or press Enter on empty item to exit' },
    { keys: ['Tab'], title: 'Indent list item', description: 'Nests deeper (Shift+Tab to outdent)' },
    { keys: ['⌘', 'B'], title: 'Bold' },
    { keys: ['⌘', 'I'], title: 'Italic' },
